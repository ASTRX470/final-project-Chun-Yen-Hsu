...
class FieldDiffusion {
 public:
  ...
  // modified by CY, 20240414
  FaceField wght; //!> weights used to integrate E to corner using GS algorithm
  AthenaArray<Real> eh2_x1f, eh3_x1f; // electric fields at x1-face from Riemann solver
  AthenaArray<Real> eh1_x2f, eh3_x2f; // electric fields at x2-face from Riemann solver
  AthenaArray<Real> eh1_x3f, eh2_x3f; // electric fields at x3-face from Riemann solver
